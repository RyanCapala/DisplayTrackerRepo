...
public class AddItemToDbHelper {
    ...
    private AlertDialog.Builder dialogBuilder, alertDialogBuilder;
    private AlertDialog dialog, _dialog;
    ...
    private View view;
    private LayoutInflater inflater, _inflater;
    ...
    //Stuff that needs to be passed in by the constructor
    /*
    context
    location
    ...
    /*
    public boolean deleteItem(final Display display) {
        String sloc = display.getShelfLocation();
        final String sname_key = findShelfNameKey(sloc);
        final String scount = getShelfCountFromSharedPref(sname_key);

        final boolean[] isDeleted = new boolean[1];
        //create alert dialog
        alertDialogBuilder = new AlertDialog.Builder(context);
        _inflater = LayoutInflater.from(context);
        final View view = _inflater.inflate(R.layout.confirmation_dialog, null);
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                displayItems.remove(adapterPosition);
                String lcount = db.getCountStr(display.getLocation());
                ...
                updateCountToSharedPref(lcount);
    ...
    */
    ...
    private void initializeThem() {
        ...
        if (isLifestyleSaleCustomShelf(location)) {
            shelf_location_array = context.getResources().getStringArray(R.array.shelf_location_lcs);
        } else {
            shelf_location_array = context.getResources().getStringArray(R.array.s1tos5_shelf_location);
        }
